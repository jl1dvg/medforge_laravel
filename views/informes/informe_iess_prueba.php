                        ...
                        <div class="box">
                            ...
                            <?php else: ?>
                                <?php if (!empty($mesSeleccionado)): ?>
                                    ...
                                    <?php endforeach; ?>
                                    <?php
                                    $baseConsolidadoParams = [];
                                    if (!empty($mesSeleccionado)) {
                                        $baseConsolidadoParams['mes'] = $mesSeleccionado;
                                    }
                                    $buildConsolidadoUrl = static function (?string $categoria = null, ?string $formato = null) use ($baseConsolidadoParams): string {
                                        $params = $baseConsolidadoParams;
                                        if (!empty($categoria)) {
                                        ...
                                        return '/informes/iess/consolidado' . $query;
                                    };
                                    ?>
                                    <div class="d-flex flex-wrap gap-2 mt-3">
                                        ...
                                        <a href="<?= htmlspecialchars($buildConsolidadoUrl(null, 'soam')) ?>" class="btn btn-outline-primary">
                                            Consolidado SOAM
                                        </a>
                                        <a href="<?= htmlspecialchars($buildConsolidadoUrl('consulta')) ?>" class="btn btn-outline-primary">
                                            Consolidado de Consultas
                                        </a>
                                        <a href="<?= htmlspecialchars($buildConsolidadoUrl('consulta', 'soam')) ?>" class="btn btn-outline-secondary">
                                            Consultas SOAM
                                        </a>
                                        <a href="<?= htmlspecialchars($buildConsolidadoUrl('imagenes')) ?>" class="btn btn-outline-info">
                                            Consolidado de Imágenes
                                        </a>
                                        <a href="<?= htmlspecialchars($buildConsolidadoUrl('imagenes', 'soam')) ?>" class="btn btn-outline-success">
                                            Imágenes SOAM
                                        </a>
                                    </div>
                                <?php else: ?>
