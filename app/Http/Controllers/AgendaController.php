...
class AgendaController extends Controller
{
    ...
    private function resolveFilters(AgendaIndexRequest $request): array
    {
        $today = now()->toDateString();
        $fechaInicio = $request->input('fecha_inicio', $today);
        ...
        return [
            'fecha_inicio' => $inicio,
            'fecha_fin' => $fin,
            'doctor' => $this->trimValue($request->input('doctor')),
            'estado' => $this->trimValue($request->input('estado')),
            'sede' => $this->trimValue($request->input('sede')),
            'solo_con_visita' => (bool) $request->boolean('solo_con_visita'),
        ];
    }
