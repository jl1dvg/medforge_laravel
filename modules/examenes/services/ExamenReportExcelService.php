...
class ExamenReportExcelService
{
    /**
    ...
    {
        $title = $options['title'] ?? 'Reporte de exámenes';
        ...
        if (empty($rows)) {
            ...
            foreach ($rows as $index => $rowData) {
                ...
                $values = [
                    ...
                    (string) ($rowData['examen_nombre'] ?? ($rowData['procedimiento'] ?? '—')),
                    (string) $estadoLabel,
                    (string) ($rowData['prioridad'] ?? '—'),
                    $this->formatDate($rowData['consulta_fecha'] ?? ($rowData['created_at'] ?? null)),
