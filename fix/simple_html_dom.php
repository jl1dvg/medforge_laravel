...
//        $pattern = "/([\w-:\*]*)(?:\#([\w-]+)|\.([\w-]+))?(?:\[@?(!?[\w-]+)(?:([!*^$]?=)[\"']?(.*?)[\"']?)?\])?([\/, ]+)/is";
        ...
        foreach ($matches as $m) {
            ...
            if ($this->dom->lowercase) {
                $tag = is_string($tag) ? strtolower($tag) : $tag;
...
class simple_html_dom
{
    ...
    protected function read_tag()
    {
        ...
        if ($this->char==='/')
        {
            ...
            // PATCH: ensure $tag is lowercased only if string, to avoid errors with null, etc.
            $tag = is_string($tag) ? strtolower($tag) : $tag;
            $parent_tag = is_string($this->parent->tag) ? strtolower($this->parent->tag) : $this->parent->tag;
            $tag_lower = $tag;
            $parent_lower = $parent_tag;
            ...
            if ($parent_lower!==$tag_lower)
            {
                if (isset($this->optional_closing_tags[$parent_lower]) && isset($this->block_tags[$tag_lower]))
                {
                    ...
                    while (($this->parent->parent) && (is_string($this->parent->tag) ? strtolower($this->parent->tag) : $this->parent->tag)!==$tag_lower)
                        $this->parent = $this->parent->parent;

                    if ((is_string($this->parent->tag) ? strtolower($this->parent->tag) : $this->parent->tag)!==$tag_lower) {
                ...
                else if (($this->parent->parent) && (is_string($this->parent->parent->tag) ? strtolower($this->parent->parent->tag) : $this->parent->parent->tag)===$tag_lower)
                {
                    $this->parent->_[HDOM_INFO_END] = 0;
                    $this->parent = $this->parent->parent;
                }
        ...
        $tag_lower = is_string($tag) ? strtolower($tag) : $tag;
        $node->tag = ($this->lowercase) ? $tag_lower : $tag;

        // handle optional closing tags
        if (isset($this->optional_closing_tags[$tag_lower]) )
        {
            while (isset($this->optional_closing_tags[$tag_lower][is_string($this->parent->tag) ? strtolower($this->parent->tag) : $this->parent->tag]))
            {
                $this->parent->_[HDOM_INFO_END] = 0;
                $this->parent = $this->parent->parent;
            }
